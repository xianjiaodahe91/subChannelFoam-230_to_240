...
myMixtureKEpsilon<BasicTurbulenceModel>::myMixtureKEpsilon
(
...
template<class BasicTurbulenceModel>
wordList myMixtureKEpsilon<BasicTurbulenceModel>::epsilonBoundaryTypes
(
...
template<class BasicTurbulenceModel>
void myMixtureKEpsilon<BasicTurbulenceModel>::correctInletOutlet
(
    volScalarField& vsf,
...
template<class BasicTurbulenceModel>
void myMixtureKEpsilon<BasicTurbulenceModel>::initMixtureFields()
{
    ...
    myMixtureKEpsilon<BasicTurbulenceModel>& turbc = this->liquidTurbulence();
...
template<class BasicTurbulenceModel>
bool myMixtureKEpsilon<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void myMixtureKEpsilon<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
myMixtureKEpsilon<BasicTurbulenceModel>&
myMixtureKEpsilon<BasicTurbulenceModel>::liquidTurbulence() const
{
    if (!liquidTurbulencePtr_)
    {
        ...
        liquidTurbulencePtr_ =
           &const_cast<myMixtureKEpsilon<BasicTurbulenceModel>&>
            (
                U.db().lookupObject<myMixtureKEpsilon<BasicTurbulenceModel> >
                (
                    IOobject::groupName
                    (
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::Ct2() const
{
    const myMixtureKEpsilon<BasicTurbulenceModel>& liquidTurbulence =
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::rholEff() const
{
    const transportModel& gas = this->transport();
    const twoPhaseSystem& fluid = gas.fluid();
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::rhogEff() const
{
    const transportModel& gas = this->transport();
    const twoPhaseSystem& fluid = gas.fluid();
    return
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::rhom() const
{
    const volScalarField& alphag = this->alpha_;
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::mix
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::mixU
(
    const volScalarField& fc,
    const volScalarField& fd
) const
...
template<class BasicTurbulenceModel>
tmp<surfaceScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::mixFlux
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> myMixtureKEpsilon<BasicTurbulenceModel>::bubbleG() const
{
    const myMixtureKEpsilon<BasicTurbulenceModel>& liquidTurbulence =
        this->liquidTurbulence();
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> myMixtureKEpsilon<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> myMixtureKEpsilon<BasicTurbulenceModel>::epsilonSource() const
{
...
template<class BasicTurbulenceModel>
void myMixtureKEpsilon<BasicTurbulenceModel>::correct()
{
    const transportModel& gas = this->transport();
    const twoPhaseSystem& fluid = gas.fluid();
    ...
    // Local references to liquid-phase properties
    myMixtureKEpsilon<BasicTurbulenceModel>& liquidTurbulence =
        this->liquidTurbulence();
